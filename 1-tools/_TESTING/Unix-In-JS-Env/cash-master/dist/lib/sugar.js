...
(function () {
  ...
  function ka(a, b) {
    function c(c) {
      return G(c)
        ? v.call(c) === "[object " + b + "]"
        : (typeof c === "undefined" ? "undefined" : _typeof(c)) === a;
    }
    return (ia[b] = c);
  }
  function na(a) {
  ...
  function va(a, b) {
    ...
    try {
      if (
        ...
        a.constructor &&
        !J(a, "constructor") &&
        !J(a.constructor.prototype, "isPrototypeOf")
      )
        return !1;
    } catch (c) {
      return !1;
  ...
  H(Function, !0, !1, {
    bind: function bind(a) {
      ...
      d = function d() {
        return b.apply(
          b.prototype && this instanceof b ? this : a,
          c.concat(L(arguments))
        );
      };
  ...
  var W,
    Ib,
    Jb =
      "ampm hour minute second ampm utc offset_sign offset_hours offset_minutes ampm".split(
        " "
      ),
    Kb =
    ...
    Rb = [
      ...
      },
      {
        ...
        b: function b(a, _b) {
          var c = 30.4375,
            d;
          a && ((d = a.daysInMonth()), _b <= d.days() && (c = d));
          return 864e5 * c;
        },
      },
          ...
          I(ha.o ? [ha.o].concat(ha.g) : ha.g, function (c, d) {
            ...
            if (g) {
              ...
              d.r &&
                !z(k.month) &&
                (z(k.date) || Zb(ha, b)) &&
                ((ca = k.month), (k.month = k.date), (k.date = ca));
              k.year &&
                2 === k.t.length &&
                (k.year =
                  100 * R(U(cc(), "FullYear") / 100) -
                  100 * R(k.year / 100) +
                  k.year);
              k.month &&
                ((k.month = B.getMonth(k.month)),
                k.shift && !k.unit && (k.unit = B.units[7]));
              k.weekday && k.date
                ? delete k.weekday
                : k.weekday &&
                  ((k.weekday = B.getWeekday(k.weekday)),
                  k.shift && !k.unit && (k.unit = B.units[5]));
              k.day && (ca = B.i[k.day])
                ? ((k.day = ca.value), n.reset(), (x = !0))
                : k.day &&
                  -1 < (Ba = B.getWeekday(k.day)) &&
                  (delete k.day,
                  k.num && k.month ? (e(f), (k.day = 1)) : (k.weekday = Ba));
              k.date && !y(k.date) && (k.date = $b(B, k.date));
              k.ampm && k.ampm === B.ampm[1] && 12 > k.hour
                ? (k.hour += 12)
                : k.ampm === B.ampm[0] && 12 === k.hour && (k.hour = 0);
              ...
              k.unit &&
                ...
                M(k.weekday) &&
                  (n.set({ weekday: k.weekday }, !0), delete k.weekday),
                (k[E] = (k[E] || 0) + ra));
              k.edge && e(h);
              ...
              fc(
                function (a, b, c) {
                  ...
                  var d = b % 1;
                  d &&
                    ((k[Ob[c - 1].name] = R(d * ("second" === a ? 1e3 : 60))),
                    (k[a] = Q(b)));
                },
                1,
                4
  ...
  function mc(a) {
    ...
    if (
      6 === b[1] ||
      (5 === b[1] && 4 === b[0] && a.daysFromNow() >= cc().daysInMonth())
    )
  ...
  function qc(a, b, c, d) {
    ...
    Date[b]
      ? (b = Date[b])
      : F(b) && ((e = mc(a)), (b = b.apply(a, e.concat(Y(d)))));
    if (!b && c)
      return (
        (e = e || mc(a)),
        0 === e[1] && ((e[1] = 1), (e[0] = 1)),
  ...
  function kc(a, b, c, d, e) {
    ...
    Rb.forEach(function (c) {
      ...
      N(h) ||
        (d
          ? ("week" === e && ((h = (b.day || 0) + 7 * h), (c = "Date")),
            (h = h * d + U(a, c)))
          : "month" === e && f("day") && Sa(a, "Date", 15),
        Sa(a, c, h),
        d &&
          "month" === e &&
          ((e = h),
  ...
  H(r, !0, !0, {
    ...
    is: function is(a, b, c) {
      ...
      if (this.isValid()) {
        if (z(a))
          switch (
            ((a = a.trim().toLowerCase()), (e = this.clone().utc(c)), !0)
          ) {
            case "future" === a:
  ...
  W = Ib = r.addLocale("en", {
    ...
    timeParse:
      "{num} {unit} {sign};{sign} {num} {unit};{0} {num}{1} {day} of {month} {year?};{weekday?} {month} {date}{1?} {year?};{date} {month} {year};{date} {month};{shift} {weekday};{shift} week {weekday};{weekday} {2?} {shift} week;{num} {unit=4-5} {sign} {day};{0?} {date}{1} of {month};{0?}{month?} {date?}{1?} of {shift} {unit=6-7}".split(
        ";"
      ),
  });
  ...
  W.addFormat(
    "([+-])?(\\d{4,4})[-.]?{full_month}[-.]?(\\d{1,2})?",
    !0,
    ["year_sign", "year", "month", "date"],
    !1,
    !0
  );
  W.addFormat(
    "(\\d{1,2})[-.\\/]{full_month}(?:[-.\\/](\\d{2,4}))?",
    !0,
    ["date", "month", "year"],
    !0
  );
