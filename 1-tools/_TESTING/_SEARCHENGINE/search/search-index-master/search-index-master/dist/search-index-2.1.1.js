  ...
  var t = {
      8508: (t, e, r) => {
        ...
        (o.prototype._checkWritten = function () {
          ...
          (o.prototype.put = function (t, e) {
            ...
            if (r) throw r;
            return (
              (t = this.db._serializeKey(t)),
              (e = this.db._serializeValue(e)),
              this._put(t, e),
              this
            );
          }),
      ...
      3538: (t, e, r) => {
        ...
        (o.prototype.next = function (t) {
          ...
          return e._ended
            ? (n(t, new Error("cannot call next() after end()")), e)
            : e._nexting
            ? (n(
                t,
                new Error(
          ...
          (o.prototype._seek = function (t) {}),
          (o.prototype.end = function (t) {
            if ("function" != typeof t)
              throw new Error("end() requires a callback argument");
            if (this._ended)
              return n(t, new Error("end() already called on iterator"));
      ...
      2554: (t, e, r) => {
        ...
        function l(t) {
          (this.status = "new"), (this.supports = o(t, { status: !0 }));
        }
        function p(t, e) {
          var r = {};
          for (var n in e)
        ...
        (l.prototype.open = function (t, e) {
          ...
          ("object" == typeof t && null !== t) || (t = {}),
            (t.createIfMissing = !1 !== t.createIfMissing),
          ...
          (l.prototype.batch = function (t, e, r) {
            ...
            if (!Array.isArray(t))
              return s(r, new Error("batch(array) requires an array argument"));
            ...
            for (var o = new Array(t.length), i = 0; i < t.length; i++) {
              ...
              var u = n(t[i]);
              if ("put" !== u.type && "del" !== u.type)
                return s(r, new Error("`type` must be 'put' or 'del'"));
          ...
          (l.prototype._setupIteratorOptions = function (t) {
            return (
              ...
              (t.values = !1 !== t.values),
              (t.limit = "limit" in t ? t.limit : -1),
              (t.keyAsBuffer = !1 !== t.keyAsBuffer),
              (t.valueAsBuffer = !1 !== t.valueAsBuffer),
              t
            );
          }),
          ...
          (l.prototype._checkKey = function (t) {
            return null == t
              ? new Error("key cannot be `null` or `undefined`")
              : i.isBuffer(t) && 0 === t.length
              ? new Error("key cannot be an empty Buffer")
              : "" === t
              ? new Error("key cannot be an empty String")
              : Array.isArray(t) && 0 === t.length
              ? new Error("key cannot be an empty Array")
              : void 0;
          }),
          ...
          (l.prototype._nextTick = s),
          (t.exports = l);
      },
      4012: (t, e, r) => {
        (e.AbstractLevelDOWN = r(2554)),
          (e.AbstractIterator = r(3538)),
          (e.AbstractChainedBatch = r(8508));
      },
      7212: (t, e, r) => {
        t.exports = r(624);
      },
      2596: (t, e, r) => {
        ...
        function p(t) {
          for (
            var e = t.length < 0 ? 0 : 0 | y(t.length), r = a(e), n = 0;
            n < e;
            n += 1
          )
            r[n] = 255 & t[n];
        ...
        (s.prototype.slice = function (t, e) {
          ...
          (s.prototype.readFloatLE = function (t, e) {
            return (
              (t >>>= 0), e || U(t, 4, this.length), o.read(this, t, !0, 23, 4)
            );
          }),
          (s.prototype.readFloatBE = function (t, e) {
            return (
              (t >>>= 0), e || U(t, 4, this.length), o.read(this, t, !1, 23, 4)
            );
          }),
          (s.prototype.readDoubleLE = function (t, e) {
            return (
              (t >>>= 0), e || U(t, 8, this.length), o.read(this, t, !0, 52, 8)
            );
          }),
          (s.prototype.readDoubleBE = function (t, e) {
            return (
              (t >>>= 0), e || U(t, 8, this.length), o.read(this, t, !1, 52, 8)
            );
          }),
      ...
      9282: (t, e, r) => {
        ...
        function T(t, e, r, n, o, i) {
          if (!(r in t) || !u(t[r], e[r])) {
            if (!n) {
              ...
              throw (
                ((f.actual = t), (f.expected = e), (f.operator = i.name), f)
              );
            }
            S({
              actual: t,
        ...
        function U(t) {
          return Promise.resolve().then(function () {
            ...
            if ("function" == typeof t) {
              if (!F((e = t())))
                throw new l("instance of Promise", "promiseFn", e);
            } else {
        ...
        var S = (function (t) {
          function e(t) {
            ...
            if (((Error.stackTraceLimit = 0), null != o))
              r = u(this, p(e).call(this, String(o)));
            else if (
              (n.stderr &&
                n.stderr.isTTY &&
                (n.stderr &&
              ...
              r = u(
                ...
                p(e).call(
                  ...
                  (function (t, e, r) {
                    ...
                    for (
                      var A = c[c.length - 1], S = l[l.length - 1];
                      A === S &&
                      (p++ < 2 ? (a = "\n  ".concat(A).concat(a)) : (o = A),
                      c.pop(),
                      l.pop(),
                      0 !== c.length && 0 !== l.length);

                    )
                      (A = c[c.length - 1]), (S = l[l.length - 1]);
                    var _ = Math.max(c.length, l.length);
                    if (0 === _) {
                      var O = f.split("\n");
                      if (O.length > 30)
                        for (
                          O[26] = "".concat(b, "...").concat(w);
                          O.length > 27;
              ...
              if (
                ("notStrictEqual" === i &&
                  "object" === h(f) &&
                  null !== f &&
                  (y = m.notStrictEqualObject),
                S.length > 30)
              )
                for (S[26] = "".concat(b, "...").concat(w); S.length > 27; )
                  S.pop();
              r =
                1 === S.length
                  ? u(this, p(e).call(this, "".concat(y, " ").concat(S[0])))
                  : u(
                      this,
                      p(e).call(
                        this,
                ...
                : ((O = "".concat(D(c))),
                  ...
                  "deepEqual" === i || "equal" === i
                    ? (_ = ""
                        ...
                        .concat(_, "\n\nshould equal\n\n"))
                    : (O = " ".concat(i, " ").concat(O))),
                (r = u(this, p(e).call(this, "".concat(_).concat(O))));
            }
            return (
          ...
          f(
            ...
            function (t, e, o) {
              ...
              if (
                ...
                s = "The ".concat(t, " ").concat(i, " ").concat(c(e, "type"));
              else {
                var p =
                  ("number" != typeof l && (l = 0),
                  l + ".".length > (f = t).length || -1 === f.indexOf(".", l)
                    ? "argument"
                    : "property");
                s = 'The "'
                  .concat(t, '" ')
      ...
      9158: (t, e, r) => {
        ...
        function x(t, e, r, n) {
          ...
          if ("[object Object]" === p && ((!v(t) && v(e)) || (!m(t) && m(e))))
            return !1;
          if (E(t)) {
            if (
              !E(e) ||
            ...
            if (
              ...
              (l = e),
              !(i
                ? f.source === l.source && f.flags === l.flags
            ...
            if (g(t)) {
              if (
                ((a = e),
                (u = t).byteLength !== a.byteLength ||
                  0 !== I(new Uint8Array(u), new Uint8Array(a)))
              )
                return !1;
            } else if (
              D(t) &&
            ...
            throw (
              ((o =
                i > 3
                  ...
                  : `>= ${e}${n} and <= ${r}${n}`),
              new N.ERR_OUT_OF_RANGE("value", o, t))
            );
          }
          !(function (t, e, r) {
            V(e, "offset"),
      ...
      2790: (t, e, r) => {
        ...
        r(5717)(o, n),
          ...
          (o.prototype._operation = function (t, e) {
            ...
            this._operations.push({ method: t, args: e });
          }),
      ...
      6944: (t, e, r) => {
        ...
        function s(t) {
          n.call(this, t.supports || {}),
            a.forEach(function (e) {
              "function" != typeof t[e] ||
                this.supports.additionalMethods[e] ||
                (this.supports.additionalMethods[e] = !0);
            }, this),
            (this._db = t),
            (this._operations = []),
            f(this);
        ...
        function f(t) {
          u.forEach(function (e) {
            t["_" + e] = function () {
              this._operations.push({ method: e, args: arguments });
            };
          }),
            ...
            (t._iterator = function (e) {
              var r = new i(t, e);
              return this._operations.push({ iterator: r }), r;
            });
        }
        o(s, n),
          (s.prototype.type = "deferred-leveldown"),
          (s.prototype._open = function (t, e) {
            var r = this;
            this._db.open(t, function (t) {
              if (t) return e(t);
              r._operations.forEach(function (t) {
                t.iterator
                  ? t.iterator.setDb(r._db)
                  : r._db[t.method].apply(r._db, t.args);
              }),
                (r._operations = []),
                (function (t) {
                  u.concat("iterator").forEach(function (e) {
                    ...
                    Object.keys(t.supports.additionalMethods).forEach(function (
                      e
                    ) {
                      t[e] = function () {
                        return this._db[e].apply(this._db, arguments);
      ...
      780: (t, e, r) => {
        ...
        function c(t, e) {
          ...
          n.call(this, r),
            (this.supports.encodings = !0),
            (this.supports.additionalMethods = {}),
            f.forEach(function (e) {
              var r = "function" == typeof t[e];
              (o[e] || r) &&
                ((this.supports.additionalMethods[e] = !0),
                (this[e] = function (t, r, n, o) {
                  return (
                    (t = this.codec.encodeKey(t, n)),
                    (r = this.codec.encodeKey(r, n)),
                    this.db[e](t, r, n, o)
                  );
                }));
            }, this),
            void 0 === (e = e || {}).keyEncoding && (e.keyEncoding = "utf8"),
            void 0 === e.valueEncoding && (e.valueEncoding = "utf8"),
            (this.db = t),
            (this.codec = new a(e));
        }
        function l(t, e) {
          i.call(this, t),
            ...
            (this.opts = this.codec.encodeLtgt(e)),
            (this.it = t.db.iterator(this.opts));
        }
        function p(t, e) {
          o.call(this, t), (this.codec = t.codec), (this.batch = t.db.batch());
        }
        (t.exports = c.default = c),
          u(c, n),
          (c.prototype.type = "encoding-down"),
          (c.prototype._serializeKey = c.prototype._serializeValue =
            function (t) {
              return t;
            }),
          ...
          (c.prototype._put = function (t, e, r, n) {
            (t = this.codec.encodeKey(t, r)),
              (e = this.codec.encodeValue(e, r)),
              this.db.put(t, e, r, n);
          }),
          (c.prototype._get = function (t, e, r) {
            var n = this;
            (t = this.codec.encodeKey(t, e)),
              (e.asBuffer = this.codec.valueAsBuffer(e)),
              this.db.get(t, e, function (t, o) {
                if (t) return r(t);
                try {
          ...
          (c.prototype._iterator = function (t) {
            return (
              (t.keyAsBuffer = this.codec.keyAsBuffer(t)),
              (t.valueAsBuffer = this.codec.valueAsBuffer(t)),
              new l(this, t)
            );
          }),
          ...
          (l.prototype._next = function (t) {
            ...
            this.it.next(function (r, n, o) {
              ...
              try {
                (n =
                  e.keys && void 0 !== n
                    ? e.codec.decodeKey(n, e.opts)
                    : void 0),
                  (o =
                    e.values && void 0 !== o
                      ? e.codec.decodeValue(o, e.opts)
                      : void 0);
              } catch (r) {
                return t(new s(r));
              }
          ...
          u(p, o),
          (p.prototype._put = function (t, e) {
            (t = this.codec.encodeKey(t)),
              (e = this.codec.encodeValue(e)),
              this.batch.put(t, e);
          }),
      ...
      6555: (t, e, r) => {
        var n = r(233);
        function o(t, e, r) {
          e && "string" != typeof e && (e = e.message || e.name),
            n(
              this,
              {
                type: t,
      ...
      7138: (t, e, r) => {
        ...
        (t.exports.errno = {}),
          ...
          (t.exports.custom = r(6555)(t.exports)),
          ...
          for (var l = 1, p = !0; l < r.length; l += 1) {
            ...
            if (
              ...
              if (s && l + 1 >= r.length) {
                ...
                a =
                  p && "get" in y && !("originalValue" in y.get) ? y.get : a[h];
              } else (p = w(a, h)), (a = a[h]);
              p && !f && (b[i] = a);
            }
          }
      ...
      8091: (t) => {
        ...
        function e(t, e) {
          ...
          for (var r = Object(t), n = 1; n < arguments.length; n++) {
            ...
            if (null != o)
              for (
                var i = Object.keys(Object(o)), u = 0, a = i.length;
                u < a;
                u++
              ) {
                var s = i[u],
          ...
          ((t = {}) =>
            new Promise((e, r) =>
              (t = Object.assign(
                ...
                ? i(n(t.db, { valueEncoding: "json" }), (n, o) =>
                    n ? r(n) : e(Object.assign(t, { _db: o }))
                  )
                : o(t.name, { valueEncoding: "json" }, (n, o) =>
                    n ? r(n) : e(Object.assign(t, { _db: o }))
                  )
            ))(t).then(f);
      },
      9563: (t) => {
        t.exports = (t) => {
          const e = (t) => "string" == typeof t,
              ...
              new Promise((r, n) => {
                ...
                if ((void 0 === e && (e = {}), "string" == typeof e)) {
                  const t = o(e).split(":"),
                    ...
                    i = t.pop();
                  return i
                    ? r({ FIELD: [i], VALUE: { GTE: n, LTE: n } })
                    : u().then((t) =>
                        r({ FIELD: t, VALUE: { GTE: n, LTE: n } })
                      );
                }
                return (
                  "string" == typeof e.VALUE &&
                    (e.VALUE = { GTE: o(e.VALUE), LTE: o(e.VALUE) }),
                  void 0 === e.VALUE && (e.VALUE = { GTE: "!", LTE: "￮" }),
                  (e.VALUE = Object.assign(e.VALUE, {
                    GTE: o(e.VALUE.GTE || "!"),
                    LTE: o(e.VALUE.LTE || "￮"),
                  })),
                  void 0 === e.FIELD
                    ? u().then((t) => r(Object.assign(e, { FIELD: t })))
                    : ((e.FIELD = [e.FIELD].flat()), r(e))
                );
              }),
            n = (t) => (t instanceof Promise ? t : r(t).then(i)),
            o = (...t) =>
              Promise.all(t.map(n)).then((t) => {
                const e = t
                  .flat(1 / 0)
                  .reduce(
                    (t, e) => (
                      e && (t[e._id] = [...(t[e._id] || []), e._match]), t
                    ),
                    {}
                  );
                return {
                  sumTokensMinusStopwords: t.filter((t) => t).length,
                  union: Object.keys(e).map((t) => ({ _id: t, _match: e[t] })),
                };
              }),
            i = (e) =>
              new Promise((r) => {
                if (
                  e.VALUE.GTE === e.VALUE.LTE &&
                  t.stopwords.includes(e.VALUE.GTE)
                )
                  return r(void 0);
                const n = {};
                return Promise.all(
                  ...
                  r(
                    Object.keys(n).map((t) => ({ _id: t, _match: n[t].sort() }))
                  )
                );
              }),
            u = () =>
              new Promise((e) => {
                const r = [];
                t._db
                  .createReadStream({ gte: "￮FIELD￮", lte: "￮FIELD￮￮" })
                  .on("data", (t) => r.push(t.value))
                  .on("end", () => e(r));
              }),
            a = (t, e) =>
              e && 0 !== e.length
                ? ((e = new Set(e.map((t) => t._id))),
                  t.map((t) =>
                    Object.assign(t, {
              ...
              r(e).then((e) =>
                n(e).then((r) => {
                  ...
                  return Object.assign(e, {
                    _id: [
                      ...r.reduce((t, e) => t.add(e._id), new Set()),
                    ].sort(),
                    VALUE: {
            ...
            c = (t, e) =>
              r(t)
                .then((t) => i(Object.assign(t, { LIMIT: 1, REVERSE: e })))
                .then((t) =>
                  t.pop()._match.pop().split(":").pop().split("#").shift()
                ),
            l = (t) =>
              r(t)
                .then((t) =>
            ...
            p = (t) =>
              r(t)
                ...
                .then((t) => t.flat());
          return {
            AGGREGATE: ({ BUCKETS: t, FACETS: e, QUERY: r }) =>
            ...
            DISTINCT: (...t) =>
              Promise.all(t.length ? t.map(l) : [l({})]).then((t) =>
                [
                  ...t
                    .flat()
                    .reduce((t, e) => t.add(JSON.stringify(e)), new Set()),
                ].map(JSON.parse)
              ),
            EXIST: (...e) =>
              new Promise((r) => {
            ...
            EXPORT: f,
            FACETS: (...t) =>
              Promise.all(t.length ? t.map(p) : [p({})]).then((t) =>
                [
                  ...t
                    .flat()
                    .reduce((t, e) => t.add(JSON.stringify(e)), new Set()),
            ...
            INTERSECTION: (...t) =>
              o(...t).then((t) =>
                t.union.filter(
                  (e) => e._match.length === t.sumTokensMinusStopwords
                )
              ),
            ...
            OBJECT: (e) =>
              Promise.all(
                e.map((e) =>
                  t._db.get("￮DOC￮" + e._id + "￮").catch((t) => null)
                )
              ).then((t) => e.map((e, r) => ((e._object = t[r]), e))),
            SET_SUBTRACTION: (t, r) =>
              Promise.all([e(t) ? n(t) : t, e(r) ? n(r) : r]).then(([t, e]) =>
                t.filter((t) => -1 === e.map((t) => t._id).indexOf(t._id))
              ),
            UNION: o,
            parseToken: r,
          };
      ...
      8936: (t, e, r) => {
        ...
        t.exports = (t) => {
          var e = 0;
          const r = (e, r) => {
              if (null == e._object) return { _id: e._id, keys: [] };
              const o = [];
              return (
                n(e._object).forEach(function (e) {
                  let n = !0;
                  const i = this.path
                  ...
                  if (
                    ("_id" === i && (n = !1),
                    r.doNotIndexField.filter((t) => i.startsWith(t)).length &&
                      (n = !1),
                    this.isLeaf &&
                      t.stopwords.includes((this.node + "").split("#")[0]) &&
                      (n = !1),
                    n && this.isLeaf)
                  ) {
                    const e = i + ":" + this.node;
                  ...
                  o(t)
                    ...
                    .then((t) => {
                      ((t, e, r) => {
                        ...
                        ((t, e) => t.map((t) => r(t, e)).reduce(i, {}))(n, f),
                        u,
                        a
                      ).then((e) =>
                        u.batch(
                                    ...
                                    : "del" === a &&
                                      (r =
                                        null === e._object
                                          ? "FAILED"
                                          : "DELETED"),
                                  { _id: e._id, operation: s, status: r }
                                );
                              })
                            )
                        )
          ...
          return {
            DELETE: (e) =>
              o(t)
                .OBJECT(e.map((t) => ({ _id: t })))
                .then((e) => u(e, t._db, "del", "DELETE", {}))
                .then(a),
            IMPORT: (e) =>
              t._db
                .clear()
                .then(() =>
                  t._db.batch(e.map((t) => Object.assign(t, { type: "put" })))
                ),
            PUT: (e, r = {}) =>
              u(
                e.map((t) => ({ _id: t._id, _object: t })),
                t._db,
                "put",
                "PUT",
                r
            ...
            TIMESTAMP_CREATED: () =>
              t._db
                .get("￮￮CREATED")
                .then()
                .catch((e) => t._db.put("￮￮CREATED", Date.now()).then(a)),
      ...
      9804: (t) => {
        ...
        t.exports = function (t, n, o) {
          ...
          var i = t.length;
          if (i === +i) for (var u = 0; u < i; u++) n.call(o, t[u], u, t);
          else for (var a in t) e.call(t, a) && n.call(o, t[a], a, t);
        };
      },
      7648: (t) => {
        "use strict";
        ...
        t.exports = function (t) {
          ...
          for (
            var u,
              ...
              f = Math.max(0, i.length - a.length),
              c = [],
              l = 0;
            l < f;
            l++
          ...
          for (var p = 1, h = !0; p < r.length; p += 1) {
            ...
            if (
              ...
              if (s && p + 1 >= r.length) {
                var E = s(f, y);
                f =
                  (h = !!E) && "get" in E && !("originalValue" in E.get)
                    ? E.get
                    : f[y];
              } else (h = w(f, y)), (f = f[y]);
              h && !c && (b[a] = f);
              ...
              e = Math.abs(e),
                isNaN(e) || e === 1 / 0
                  ...
                  : ((u = Math.floor(Math.log(e) / Math.LN2)),
                    ...
                    (e += u + l >= 1 ? p / s : p * Math.pow(2, 1 - l)) * s >=
                      2 && (u++, (s /= 2)),
                    u + l >= c
                      ? ((a = 0), (u = c))
                      : u + l >= 1
                      ...
                      : ((a = e * Math.pow(2, l - 1) * Math.pow(2, o)),
                        (u = 0)));
              o >= 8;
              t[r + h] = 255 & a, h += y, a /= 256, o -= 8
            );
            for (
              u = (u << o) | a, f += o;
              f > 0;
              t[r + h] = 255 & u, h += y, u /= 256, f -= 8
            );
            t[r + h - y] |= 128 * d;
          });
      },
      624: (t, e, r) => {
        ...
        var n,
          o,
          i,
          u = [r(2692), r(4785), r(8291), r(2709), r(2506), r(9176)],
          a = -1,
          s = [],
          f = !1;
        function c() {
      ...
      360: (t, e, r) => {
        ...
        var n = r(5559),
          ...
          a = r(3194),
          s = n(u(), Number);
        o(s, { getPolyfill: u, implementation: i, shim: a }), (t.exports = s);
      },
      9415: (t, e, r) => {
        "use strict";
        var n = r(8611);
      ...
      4124: (t, e, r) => {
        ...
        (t.exports = o),
          (o.prototype._encoding = function (t) {
          ...
          (o.prototype.encodeBatch = function (t, e) {
            ...
            return t.map(function (t) {
              var n = { type: t.type, key: r.encodeKey(t.key, e, t) };
              return (
                r.keyAsBuffer(e, t) && (n.keyEncoding = "binary"),
                t.prefix && (n.prefix = t.prefix),
                "value" in t &&
                  ((n.value = r.encodeValue(t.value, e, t)),
                  r.valueAsBuffer(e, t) && (n.valueEncoding = "binary")),
                n
              );
            });
          });
        ...
        (o.prototype.encodeLtgt = function (t) {
          ...
          (o.prototype.createStreamDecoder = function (t) {
            ...
            return t.keys && t.values
              ? function (r, n) {
                  return { key: e.decodeKey(r, t), value: e.decodeValue(n, t) };
                }
              : t.keys
              ? function (r) {
      ...
      964: (t, e, r) => {
        ...
        (e.utf8 = e["utf-8"] =
          ...
          (e.none = { encode: o, decode: o, buffer: !1, type: "id" }),
          (e.id = e.none),
          [
            "hex",
            "ascii",
        ...
        (t.exports = u),
          ...
          (u.prototype._read = function () {
            var t = this,
              e = this._options;
            this.destroyed ||
              this._iterator.next(function (r, n, o) {
                if (!t.destroyed)
                  return r
                    ? t.destroy(r)
                    : void (void 0 === n && void 0 === o
                        ? t.push(null)
                        : !1 !== e.keys && !1 === e.values
                        ? t.push(n)
                        : !1 === e.keys && !1 !== e.values
      ...
      9558: (t, e, r) => {
        ...
        function p(t, e) {
          ...
          (this.location = t),
            (this.prefix = null == e.prefix ? l : e.prefix),
            (this.version = parseInt(e.version || 1, 10));
        }
        o(p, n),
          (p.prototype.type = "level-js"),
          (p.prototype._open = function (t, e) {
            ...
            (r.onerror = function () {
              ...
              (r.onupgradeneeded = function (t) {
                ...
                e.objectStoreNames.contains(n.location) ||
                  e.createObjectStore(n.location);
              });
          }),
          (p.prototype.store = function (t) {
            return this.db
              .transaction([this.location], t)
              .objectStore(this.location);
          }),
          ...
          (p.prototype.upgrade = function (t) {
            if ("open" !== this.status)
              return this._nextTick(
                t,
                new Error("cannot upgrade() before open()")
              );
            var e = this.iterator(),
              r = {},
              n = this;
            ...
            (e._deserializeKey = e._deserializeValue =
              function (t) {
                return t;
              }),
              o();
      ...
      3016: (t, e, r) => {
        ...
        function s(t, e, r) {
          if (
            ...
            (this._keyAsBuffer = r.keyAsBuffer),
            (this._valueAsBuffer = r.valueAsBuffer),
            0 !== this._limit)
          ) {
            try {
              var n = i(r);
        ...
        (t.exports = s),
          n(s, o),
          (s.prototype.createIterator = function (t, e, r) {
            var n = this,
              o = this.db.db.transaction([t], "readonly");
            (o.objectStore(t).openCursor(e, r ? "prev" : "next").onsuccess =
              function (t) {
                var e = t.target.result;
                e && n.onItem(e);
              }),
          ...
          (s.prototype.onItem = function (t) {
            this._cache.push(t.key, t.value),
              (this._limit <= 0 || ++this._count < this._limit) && t.continue(),
              this.maybeNext();
          }),
          ...
          (s.prototype.maybeNext = function () {
            this._callback &&
              (this._next(this._callback), (this._callback = null));
          }),
          (s.prototype._next = function (t) {
            if (this._aborted) {
              ...
              (r =
                this._keys && void 0 !== r
                  ? this._deserializeKey(r, this._keyAsBuffer)
                  : void 0),
                (n =
                  this._values && void 0 !== n
                    ? this._deserializeValue(n, this._valueAsBuffer)
                    : void 0),
                this._nextTick(t, null, r, n);
            } else this._completed ? this._nextTick(t) : (this._callback = t);
          }),
          (s.prototype._deserializeKey = u),
          (s.prototype._deserializeValue = u),
      ...
      2854: (t) => {
        ...
        t.exports = function (t, e, r, n, o) {
          ...
          u[s](r, f).onsuccess = function (t) {
            var e = t.target.result;
            e &&
              (u.delete(e.key).onsuccess = function () {
      ...
      8450: (t, e, r) => {
        ...
        function u(t) {
          ...
          return t.byteLength === t.buffer.byteLength
            ? e
            : e.slice(t.byteOffset, t.byteOffset + t.byteLength);
        }
        t.exports = function (t, e) {
      ...
      8950: (t, e, r) => {
        ...
        t.exports = function (t) {
          ...
          return e !== o && r !== o
            ? IDBKeyRange.bound(e, r, i, u)
            : e !== o
            ? IDBKeyRange.lowerBound(e, i)
            : r !== o
            ? IDBKeyRange.upperBound(r, u)
            : null;
        };
      },
      5568: (t, e, r) => {
      ...
      2147: (t, e, r) => {
        ...
        t.exports = function (t) {
          ...
          return (
            ["destroy", "repair"].forEach(function (r) {
              "function" == typeof t[r] &&
                (e[r] = function () {
      ...
      8133: (t, e, r) => {
        ...
        (a.prototype.put = function (t, e) {
          ...
          return (
            this.ops.push({ type: "put", key: t, value: e }),
            this.length++,
            this
          );
        }),
          (a.prototype.del = function (t) {
            ...
            return this.ops.push({ type: "del", key: t }), this.length++, this;
          }),
      ...
      4918: (t, e, r) => {
        ...
        function A(t, e) {
          if (!t._isOpening() && !t.isOpen())
            return n.nextTick(e, new b("Database is not open")), !0;
        }
        (m.prototype.emit = o.prototype.emit),
          (m.prototype.once = o.prototype.once),
          i(m, o),
          (m.prototype.open = function (t, e) {
            var r,
              o = this;
            return (
            ...
            return (
              ...
              this.isOpen()
                ? (this.db.close(function () {
                  ...
                  this.emit("closing"),
                  (this.db = new a(this._db)))
                : this.isClosed()
                ? n.nextTick(t)
                : "closing" === this.db.status
                ? this.once("closed", t)
                : this._isOpening() &&
                  this.once("open", function () {
                    r.close(t);
          ...
          (m.prototype.get = function (t, e, r) {
            var n;
            return (
              (r = y(e, r)) || (n = (r = h()).promise),
              A(this, r) ||
                ((e = d(e)),
                this.db.get(t, e, function (e, n) {
                  if (e)
                    return (
                      (e =
                        /notfound/i.test(e) || e.notFound
                          ? new E("Key not found in database [" + t + "]", e)
                          : new b(e)),
                      r(e)
                    );
                  r(null, n);
          ...
          (m.prototype.put = function (t, e, r, n) {
            var o,
              i = this;
            return (
              (n = y(r, n)) || (o = (n = h()).promise),
              A(this, n) ||
                ((r = d(r)),
                this.db.put(t, e, r, function (r) {
          ...
          (m.prototype.batch = function (t, e, r) {
            ...
            var n,
              o = this;
            return (
              (r = "function" == typeof t ? t : y(e, r)) ||
                (n = (r = h()).promise),
              A(this, r) ||
                ((e = d(e)),
                this.db.batch(t, e, function (e) {
                  if (e) return r(new g(e));
                  o.emit("batch", t), r();
                })),
              n
          ...
          (m.prototype.readStream = m.prototype.createReadStream =
            function (t) {
              return (
                "number" != typeof (t = u({ keys: !0, values: !0 }, t)).limit &&
                  (t.limit = -1),
                new s(this.db.iterator(t), t)
              );
            }),
          (m.prototype.keyStream = m.prototype.createKeyStream =
            function (t) {
              return this.createReadStream(u(t, { keys: !0, values: !1 }));
            }),
          (m.prototype.valueStream = m.prototype.createValueStream =
            function (t) {
              return this.createReadStream(u(t, { keys: !1, values: !0 }));
            }),
          (m.prototype.toString = function () {
            return "LevelUP";
          }),
          (m.prototype.type = "levelup"),
          (m.errors = c),
          (t.exports = m.default = m);
      },
      5160: (t) => {
        t.exports = function () {
          var t,
          ...
          r(
            ...
            function (t, e, r) {
              ...
              if (
                ...
                u = "The ".concat(t, " ").concat(o, " ").concat(n(e, "type"));
              else {
                var f =
                  ("number" != typeof s && (s = 0),
                  s + ".".length > (a = t).length || -1 === a.indexOf(".", s)
                    ? "argument"
                    : "property");
                u = 'The "'
                  .concat(t, '" ')
      ...
      9481: (t, e, r) => {
        ...
        function O(t, e, r, n, o) {
          ...
          if (null === e)
                ...
                if ((i("onEofChunk"), !e.ended)) {
                  ...
                  (e.ended = !0),
                    e.sync
                      ? R(t)
                      : ((e.needReadable = !1),
                        e.emittedReadable || ((e.emittedReadable = !0), F(t)));
                }
              })(t, a);
          else if (
            (o ||
              (u = (function (t, e) {
                ...
                return (
                  ...
                  s.isBuffer(n) ||
                    ...
                    void 0 === e ||
                    t.objectMode ||
                    (r = new E("chunk", ["string", "Buffer", "Uint8Array"], e)),
                  r
                );
              })(a, e)),
            u)
            ...
            if (
              ...
              a.endEmitted ? A(t, new m()) : B(t, a, e, !0);
              ...
              (a.reading = !1),
                a.decoder && !r
                  ? ((e = a.decoder.write(e)),
                    a.objectMode || 0 !== e.length ? B(t, a, e, !1) : U(t, a))
                  : B(t, a, e, !1);
            }
        ...
        Object.defineProperty(_.prototype, "destroyed", {
          ...
          (_.prototype.destroy = d.destroy),
          (_.prototype._undestroy = d.undestroy),
        ...
        function N(t) {
          ...
          i("endReadable", e.endEmitted),
            e.endEmitted || ((e.ended = !0), o.nextTick(M, e, t));
        }
        function M(t, e) {
          if (
        ...
        (_.prototype.read = function (t) {
          ...
          (_.prototype.pipe = function (t, e) {
            ...
            var a =
              (e && !1 === e.end) || t === o.stdout || t === o.stderr ? d : s;
            function s() {
              i("onend"), t.end();
            }
              ...
              "data" === t
                ...
                : "readable" === t &&
                  (n.endEmitted ||
                    ...
                    n.length ? R(this) : n.reading || o.nextTick(k, this))),
              r
            );
          }),
          ...
          (_.prototype.resume = function () {
            ...
            return (
              t.flowing ||
                ...
                (function (t, e) {
                  e.resumeScheduled ||
                    ((e.resumeScheduled = !0), o.nextTick(j, t, e));
                })(this, t)),
              (t.paused = !1),
              this
            );
          ...
          (_.prototype.wrap = function (t) {
            ...
            for (var u = 0; u < D.length; u++)
              t.on(D[u], this.emit.bind(this, D[u]));
            return (
          ...
          "function" == typeof Symbol &&
            (_.prototype[Symbol.asyncIterator] = function () {
      ...
      4229: (t, e, r) => {
        ...
        function S(t, e, u) {
          (n = n || r(6753)),
            ...
            (this.objectMode = !!t.objectMode),
            u && (this.objectMode = this.objectMode || !!t.writableObjectMode),
              ...
              !(function (t, e) {
                ...
                if (
                  ...
                  u ||
                    ...
                    !r.bufferedRequest ||
                    T(t, r),
                    n ? o.nextTick(B, t, r, u, i) : B(t, r, u, i);
                }
              })(e, t);
            }),
            (this.writecb = null),
          ...
          if (t._writev && r && r.next) {
            ...
            for (; r; ) {
              var f = r.chunk,
                ...
                l = r.callback;
              if (
                (O(t, e, !1, e.objectMode ? 1 : f.length, f, c, l),
                (r = r.next),
        ...
        r(5717)(_, s),
            ...
            ? ((u = Function.prototype[Symbol.hasInstance]),
              Object.defineProperty(_, Symbol.hasInstance, {
                value: function (t) {
                  return (
                    !!u.call(this, t) ||
                    (this === _ && t && t._writableState instanceof S)
                  );
                },
              }))
            : (u = function (t) {
          ...
          (_.prototype.destroy = l.destroy),
          (_.prototype._undestroy = l.undestroy),
          (_.prototype._destroy = function (t, e) {
            e(t);
          });
      },
      5850: (t, e, r) => {
        ...
        function d(t) {
          ...
          if (null !== e) {
            var r = t[h].read();
            null !== r &&
              ((t[l] = null), (t[a] = null), (t[s] = null), e(y(r, !1)));
          }
        }
        function g(t) {
          o.nextTick(d, t);
            ...
            r = Object.create(
              ...
              i(e, p, {
                value: function (t, e) {
                  var n = r[h].read();
                  n
                    ? ((r[l] = null), (r[a] = null), (r[s] = null), t(y(n, !1)))
                    : ((r[a] = t), (r[s] = e));
                },
                writable: !0,
              }),
          ...
          return (
            ...
            u(t, function (t) {
              if (t && "ERR_STREAM_PREMATURE_CLOSE" !== t.code) {
                ...
                return (
                  null !== e &&
                    ((r[l] = null), (r[a] = null), (r[s] = null), e(t)),
                  void (r[f] = t)
                );
              }
              var n = r[a];
              null !== n &&
                ((r[l] = null), (r[a] = null), (r[s] = null), n(y(void 0, !0))),
                (r[c] = !0);
            }),
      ...
      9946: (t, e, r) => {
        ...
        function s(t, e, o, i) {
          ...
          t.on("close", function () {
            ...
            void 0 === n && (n = r(8610)),
            n(t, { readable: e, writable: o }, function (t) {
              if (t) return i(t);
              (a = !0), i();
            });
          var s = !1;
      ...
      971: (t) => {
        t.exports = function (t, e) {
          e = Object.assign({}, { ngramLengths: [1] }, e);
          const r = t.reduce(
            (t, r, n, o) => (
              e.ngramLengths.forEach((e) => {
                var i = o.slice(n, n + e);
                i.length === e &&
                  ((r = JSON.stringify(i)), (t[r] = t[r] || []), t[r].push(n));
              }),
              t
            ),
            {}
          ...
          return Object.keys(r)
            .map((t) => ({ term: JSON.parse(t), positions: r[t] }))
          ...
          return (function t(l) {
            var p = r ? o(l) : l,
              ...
              d = {
                ...
                circular: null,
                update: function (t, e) {
                  d.isRoot || (d.parent.node[d.key] = t),
                    (d.node = t),
                    e && (y = !1);
                },
                delete: function (t) {
            ...
            function g() {
              if ("object" == typeof d.node && null !== d.node) {
                (d.keys && d.node_ === d.node) || (d.keys = i(d.node)),
            ...
            return (
              void 0 !== b && d.update && d.update(b),
              h.before && h.before.call(d, d.node),
              y
                ? ("object" != typeof d.node ||
                    ...
                    (u.push(d),
                    g(),
                    s(d.keys, function (e, o) {
                      n.push(e), h.pre && h.pre.call(d, d.node[e], e);
                      var i = t(d.node[e]);
                      r && f.call(d.node, e) && (d.node[e] = i.node),
                        (i.isLast = o == d.keys.length - 1),
                        (i.isFirst = 0 == o),
                        h.post && h.post.call(d, i),
                        n.pop();
                    }),
                    u.pop()),
                  h.after && h.after.call(d, d.node),
                  d)
                : d
            );
          })(t).node;
        ...
        (r.prototype.get = function (t) {
          ...
          (r.prototype.clone = function () {
            var t = [],
              e = [];
            return (function r(n) {
              for (var u = 0; u < t.length; u++) if (t[u] === n) return e[u];
      ...
      5955: (t, e, r) => {
        ...
        function S(t) {
          return (
            ...
            (D.working ? D(t) : t instanceof DataView)
          );
        }
        function _(t) {
        ...
        function O(t) {
          return (
            "undefined" != typeof SharedArrayBuffer &&
            (_.working ? _(t) : t instanceof SharedArrayBuffer)
          );
        }
        function B(t) {
          return g(t, l);
        ...
        (e.isArgumentsObject = n),
          ...
          (e.isSet = function (t) {
            return (
              "undefined" != typeof Set && (E.working ? E(t) : t instanceof Set)
            );
          }),
      ...
      9539: (t, e, r) => {
        ...
        function p(t, r, n) {
          ...
          if (
            (t.showHidden && (u = Object.getOwnPropertyNames(r)),
            S(r) &&
          ...
          return (
            d(r) && ((l = !0), (A = ["[", "]"])),
            _(r) && (c = " [Function" + (r.name ? ": " + r.name : "") + "]"),
            m(r) && (c = " " + RegExp.prototype.toString.call(r)),
            D(r) && (c = " " + Date.prototype.toUTCString.call(r)),
            S(r) && (c = " " + h(r)),
      ...
      4265: (t) => {
        t.exports = class {
          ...
          set(t, e) {
            return (
              this.LRUStore.size === this.limit &&
                this.LRUStore.delete(Array.from(this.LRUStore.keys()).shift()),
              this.LRUStore.delete(t),
              this.LRUStore.set(t, e),
              e
            );
          }
          cache(t, e) {
            return (
              (t = JSON.stringify(t)),
              this.has(t)
                ? new Promise((e) => e(this.get(t)))
                : e.then((e) => this.set(t, e))
            );
          }
          flush() {
        ...
        const n = r(7270),
          ...
          a = (t) => {
            ...
            return {
              ...
              DICTIONARY: (t) =>
                e.cache({ DICTIONARY: t || null }, n.DICTIONARY(t)),
              DISTINCT: n.DISTINCT,
              DOCUMENTS: (t) =>
                e.cache({ DOCUMENTS: t || null }, n.DOCUMENTS(t)),
              ...
              QUERY: (t, r) => e.cache({ QUERY: [t, r] }, n.QUERY(t, r)),
            };
          };
        t.exports = (t) =>
          ((t = {}) =>
            new Promise(
              (e, r) => (
                ...
                n(t).then((r) => e(Object.assign({ fii: r }, t)))
              )
            ))(t).then(a);
      },
      6291: (t) => {
        t.exports = (t) => {
          const e = (e) =>
              new Promise((r, n) => {
                ...
                t.STORE.createReadStream({
                  ...
                  .on("data", (t) =>
                    o.push({ _id: t.value._id, _doc: t.value })
                  )
                  .on("end", () => r(o));
              }),
            r = (r) =>
              Array.isArray(r)
                ? Promise.all(
                    r.map((e) =>
                      t.STORE.get("￮DOC_RAW￮" + e + "￮").catch((t) => null)
                    )
                  )
                : e(),
            n = (...e) =>
                  ...
                  [
                    ...t.reduce(
                      (t, e) =>
                        t.add(
                          JSON.stringify(
                            Object.assign(e, { VALUE: e.VALUE.split("#")[0] })
                          )
                        ),
                      new Set()
                    ),
            ...
            i = (t, e) => {
              const r =
                  (e = Object.assign({ NUMBER: 0, SIZE: 20 }, e || {})).NUMBER *
                  e.SIZE,
                n = r + e.SIZE || void 0;
              return t.slice(r, n);
            },
            ...
            s = (t, e) => {
              e = Object.assign(
                { DIRECTION: "DESCENDING", FIELD: "_score", TYPE: "NUMERIC" },
                e || {}
              );
              const r = (t) => {
          ...
          return {
            ...
            DICTIONARY: (t) =>
              n(t).then((t) =>
                Array.from(t.reduce((t, e) => t.add(e.VALUE), new Set())).sort()
              ),
            DISTINCT: n,
            DOCUMENTS: r,
            DOCUMENT_COUNT: f,
            ...
            QUERY: (e, n = {}) => {
              const f = (e) =>
                "string" == typeof e || e.FIELD || e.VALUE
                  ? t.GET(e)
                  : e.AND
                  ? t.AND(...e.AND.map(f))
                  : e.DOCUMENTS
                  ...
                  ? t.GET(e.GET)
                  : e.NOT
                  ? t.SET_SUBTRACTION(f(e.NOT.INCLUDE), f(e.NOT.EXCLUDE))
                  : e.OR
                  ? t.OR(...e.OR.map(f))
                  : e.SEARCH
                  ? a(...e.SEARCH.map(f))
              ...
              return f(e)
                .then((t) =>
                  t.RESULT
                    ? Object.assign(t, { RESULT_LENGTH: t.RESULT.length })
                    : { RESULT: t, RESULT_LENGTH: t.length }
                )
                .then((t) =>
                  n.DOCUMENTS
                    ? r(t.RESULT.map((t) => t._id)).then((e) =>
                        Object.assign(t, {
                          RESULT: t.RESULT.map((t, r) =>
                            Object.assign(t, { _doc: e[r] })
                          ),
                        })
                      )
                    : t
                ...
                .then((t) =>
                  n.SCORE
                    ? u(t.RESULT, n.SCORE).then((e) =>
                        Object.assign(t, { RESULT: e })
                      )
                    : t
                )
                .then((t) =>
                  Object.assign(
                    t,
                    n.SORT ? { RESULT: s(t.RESULT, n.SORT) } : {}
                  )
                )
                .then((e) =>
                  n.BUCKETS
                ...
                .then((e) =>
                  n.FACETS
                    ? e.RESULT.length
                      ...
                      : Object.assign(e, { FACETS: [] })
                    : e
                )
                .then((t) =>
                  Object.assign(
                    t,
                    n.PAGE ? { RESULT: i(t.RESULT, n.PAGE) } : {}
                  )
                );
            },
          };
      ...
      6761: (t, e, r) => {
        ...
        t.exports = (t, e) => {
          const r = (t) =>
                ...
                if ("_id" === n) t[n] = u + "";
                  ...
                  const o = i(
                      u
                        ...
                        .map((t) => (e.caseSensitive ? t : t.toLowerCase()))
                    ),
                  ...
                  e.caseSensitive || (r = r.toLowerCase()),
                    (t[n] = i(r.split(/\s+/).filter((t) => t)).sort());
                }
                return t;
              }, {}),
            n = (t) => ("string" == typeof t ? { body: t } : t),
            u = (t, e) =>
              void 0 === t._id
                ? Object.assign(t, { _id: Date.now() + "-" + e })
                : t,
            a = (o, i) =>
              ((t) => new Promise((e) => e(t.map(n).map(u))))(o).then((n) =>
                t.PUT(n.map(r), Object.assign(e, i)).then((r) => {
                  return Promise.all([
                    s(n, !e.storeRawDocs),
                    ((o = r.filter((t) => "CREATED" === t.status).length),
                    t.STORE.get("￮DOCUMENT_COUNT￮")
                      .then((e) => t.STORE.put("￮DOCUMENT_COUNT￮", +e + o))
                      .catch((e) => t.STORE.put("￮DOCUMENT_COUNT￮", o))),
                  ]).then(() => r);
                  var o;
                })
              ),
            s = (e, r) =>
              Promise.all(
                e.map((e) => t.STORE.put("￮DOC_RAW￮" + e._id + "￮", r ? {} : e))
              ).then((t) =>
                e.map((t) => ({
                  _id: t._id,
                  status: "OK",
            ...
            f = (e) =>
              t.DELETE(e).then((e) => {
                ...
                return Promise.all([
                  Promise.all(
                    r.map((e) => t.STORE.del("￮DOC_RAW￮" + e._id + "￮"))
                  ),
                  ((n = r.length),
                  t.STORE.get("￮DOCUMENT_COUNT￮").then((e) =>
                    t.STORE.put("￮DOCUMENT_COUNT￮", +e - n)
                  )),
                ]).then(() => e);
                var n;
              });
