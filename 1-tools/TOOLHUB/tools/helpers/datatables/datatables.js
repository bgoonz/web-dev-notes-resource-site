  ...
  ( function ( $, window, document, undefined ) {
    ...
    var DataTable = function ( options ) {
      ...
      this.fnGetNodes = function ( iRow ) {
        e = 0,
          i = "";iRow !== undefined ? api.row( iRow ).node() : api.rows().nodes().flatten().toArray();
      };
      ...
      return "object" == typeof i ? null !== i && "function" == typeof i.concat && ( n = i.concat() ) : "string" == typeof i && ( n = i.split( /[^a-zA-Z0-9_\/\-]+/ ) ), n
        ...
        var n = this._get_selection_list( t, e, i );Init, $this.data() ) );
    ...
    function ( t, e, i ) {ayStart = oInit.iDisplayStart;
        }
        if ( oInit.iDeferLoading !== null ) {
      l = i( 2 ).Output,
        d = i( 8 ).InputScanner,
        f = /\r\n|[\r\n]/,
        g = /\r\n|[\r\n]/g,ordsTotal = tmp ? oInit.iDeferLoading[ 1 ] : oInit.iDeferLoading;
        }
