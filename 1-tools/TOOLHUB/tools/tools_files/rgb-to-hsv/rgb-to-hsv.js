...
function rgbtohsv() {
  ...
  colors.g = $( '#g' ).val();
  colors.b = $( '#b' ).val();
  color_picker.colpickSetColor( colors );
}
...
function drawColorTable() {
  ...
  color_picker = $( "#colorPalette" ).colpick( {
    flat: true,
    layout: "hex",
    submit: 0,
    color: {
    ...
    onChange: function ( e, h, a ) {
      ...
      $( '#hex' ).val( h );
      var hsv_val = "HSV(" + h_val + "," + s_val + "," + v_val + ")";
      $( '#copyhsv' ).attr( 'data-clipboard-text', hsv_val );
    }
  } )
...
var clipboard = new ClipboardJS( '#copyhsv' );
