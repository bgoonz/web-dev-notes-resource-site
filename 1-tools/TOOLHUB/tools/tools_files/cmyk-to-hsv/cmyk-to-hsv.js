...
function cmyk2rgb() {
  ...
  $( '#colorEffect' ).css( "background-color", "rgb(" + r + ", " + g + ", " + b + ")" );
  var hsb_value = rgb2hsv( r, g, b );
  y = hsb_value.split( "," );
  hsbVal = "HSV(" + y[ 0 ] + "," + y[ 1 ] + "," + y[ 2 ] + ")";



  $( "#h" ).val( y[ 0 ] ), $( "#s" ).val( y[ 1 ] ), $( "#v" ).val( y[ 2 ] );

  $( '#copyhsb' ).attr( "data-clipboard-text", hsbVal );
...
function drawColorTable() {
  ...
  $( "#colorPalette" ).colpick( {
    ...
    onChange: function ( e, h, a ) {
      ...
      var hsv_val = "HSV(" + e.h + ", " + e.s + ", " + e.b + ")";
      $( '#copyhsb' ).attr( 'data-clipboard-text', hsv_val );
    }
  } )
...
var clipboard = new ClipboardJS( '#copyhsb' );
