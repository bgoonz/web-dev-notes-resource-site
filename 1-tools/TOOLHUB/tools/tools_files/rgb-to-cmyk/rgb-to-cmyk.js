...
function cmyk2rgb() {
  ...
  $( '#colorEffect' ).css( "background-color", "rgb(" + r + ", " + g + ", " + b + ")" );
  rgbVal = "rgb(" + r + "," + g + "," + b + ")";
  $( '#copyCMYK' ).data( "clipboard-text", rgbVal );
}
...
function drawColorTable() {
  ...
  colorPalette = $( "#colorPalette" ).colpick( {
    flat: true,
    layout: "hex",
    submit: 0,
    color: {
      ...
      var cmyk_val = "CMYK(" + c[ 0 ] + ", " + c[ 1 ] + ", " + c[ 2 ] + ", " + c[ 3 ] + ")";


      $( '#copycmyk' ).attr( 'data-clipboard-text', cmyk_val );
...
var clipboards = new ClipboardJS( '#copycmyk' );
