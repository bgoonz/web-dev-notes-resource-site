...
function hsvtocmyk() {
  ...
  var rgb = hsv2rgb();
  rgb = rgb.split( ',' );
  //colors_section.colpickSetColor({'r':rgb[0],'g':rgb[1],'b':rgb[2]})
  $( '#colorEffect' ).css(
  ...
  $( '#y' ).val( cmyk.y );
  $( '#k' ).val( cmyk.k );
  var cmyk_val = "CMYK(" + cmyk.c + "," + cmyk.m + ", " + cmyk.y + ", " + cmyk.k + ")";
...
function drawColorTable() {
  ...
  colorsSection = $( "#colorPalette" ).colpick( {
    flat: true,
    layout: "hex",
    submit: 0,
    onChange: function ( e, h, a ) {
      ...
      $( "#c" ).val( c.c ), $( "#m" ).val( c.m ), $( "#y" ).val( c.y ), $( "#k" ).val( c.k );

      $( '#colorEffect' ).css(
        "background-color", "rgb(" + a.r + ", " + a.g + ", " + a.b + ")"
      )

      var cmyk_val = "CMYK(" + c.c + "," + c.m + ", " + c.y + ", " + c.k + ")";
      $( '#copycmyk' ).attr( 'data-clipboard-text', cmyk_val );
...
var clipboard = new ClipboardJS( '#copycmyk' );
