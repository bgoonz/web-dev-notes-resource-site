...
01. Fork this repo and clone it to your local machine
02. Open `SpecRunner.html` in your web browser
03. Code your solutions in `recursion.js`
04. Review the tests in `spec/part1.js` and `spec/part2.js` as necessary
05. Save your work and refresh your browser to check for passing/failing tests
...
02. Is 2 zero??
03. No, print message to console that 2 is not zero
...
05. Is 1 zero??
06. No, print message that 1 is not zero
7. Invoke `stepsToZero(n-1)` where `n-1` evaluates to `0`
08. Is 0 zero??
09. Yes, return message that reached zero
...
06. Return out of the invocation from step 4
