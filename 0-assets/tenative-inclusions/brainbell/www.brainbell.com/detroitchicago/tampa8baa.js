__ez.vaep = ( function () {
    var pixels = [], pxURL = "/porpoiseant/lemon.gif"; function AddPixel ( vaID, pixelData ) { if ( __ez.dot.isDefined( vaID ) && __ez.dot.isValid( pixelData ) ) { pixels.push( { type: 'video-ad', video_ad_impression_id: vaID, domain_id: __ez.dot.getDID(), t_epoch: __ez.dot.getEpoch( 0 ), data: __ez.dot.dataToStr( pixelData ) } ); } }
    function Fire () {
