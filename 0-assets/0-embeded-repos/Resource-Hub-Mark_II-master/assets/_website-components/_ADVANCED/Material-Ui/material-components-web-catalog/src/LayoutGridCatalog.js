...
const LayoutGridCatalog = () => {
  return ( <
    ...
    s responsive UI is based on a 12 - column grid layout.
    '
...
const LayoutGridDemos = () => {
  return ( <
    ...
    cols = '6' > < /LayoutGridCell> <
    LayoutGridCell className = 'demo-cell'
    cols = '3' > < /LayoutGridCell> <
    LayoutGridCell className = 'demo-cell'
    cols = '2' > < /LayoutGridCell> <
    LayoutGridCell className = 'demo-cell'
    cols = '1' > < /LayoutGridCell> <
    LayoutGridCell className = 'demo-cell'
    cols = '3' > < /LayoutGridCell> <
    LayoutGridCell className = 'demo-cell'
    cols = '1' > < /LayoutGridCell> <
    LayoutGridCell className = 'demo-cell'
    cols = '8' > < /LayoutGridCell> <
    /LayoutGridInner> <
    /LayoutGrid>
    ...
    LayoutGrid className = 'demo-grid demo-grid--alignment'
    align = 'left' >
    <
    LayoutGridInner >
    <
    ...
    <
    LayoutGridCell className = 'demo-cell demo-cell--alignment'
    align = 'top' > < /LayoutGridCell> <
    LayoutGridCell className = 'demo-cell demo-cell--alignment'
    align = 'middle' > < /LayoutGridCell> <
    LayoutGridCell className = 'demo-cell demo-cell--alignment'
    align = 'bottom' > < /LayoutGridCell> <
    /LayoutGridInner> <
    /LayoutGrid> <
    /div>
  )
