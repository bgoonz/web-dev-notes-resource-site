...
```sh
$ cd src/apis/eventarc
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/eventarc.min.js`. Use it from your HTML file:

```html
<script src="/path/to/eventarc.min.js"></script>
<script>
const { eventarc, auth } = Eventarc;
</script>
```
