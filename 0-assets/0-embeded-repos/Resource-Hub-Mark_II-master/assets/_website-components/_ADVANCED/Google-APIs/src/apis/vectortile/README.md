...
```sh
$ cd src/apis/vectortile
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/vectortile.min.js`. Use it from your HTML file:

```html
<script src="/path/to/vectortile.min.js"></script>
<script>
const { vectortile, auth } = Vectortile;
</script>
```
