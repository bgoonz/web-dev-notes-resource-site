...
```sh
$ cd src/apis/analyticsdata
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/analyticsdata.min.js`. Use it from your HTML file:

```html
<script src="/path/to/analyticsdata.min.js"></script>
<script>
const { analyticsdata, auth } = Analyticsdata;
</script>
```
