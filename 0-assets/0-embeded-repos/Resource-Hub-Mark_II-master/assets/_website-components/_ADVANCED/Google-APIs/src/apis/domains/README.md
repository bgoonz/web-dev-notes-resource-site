...
The generated bundle will be written to `dist/domains.min.js`. Use it from your HTML file:

```html
<script src="/path/to/domains.min.js"></script>
<script>
