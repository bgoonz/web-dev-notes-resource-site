...
```sh
$ cd src/apis/displayvideo
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/displayvideo.min.js`. Use it from your HTML file:

```html
<script src="/path/to/displayvideo.min.js"></script>
<script>
const { displayvideo, auth } = Displayvideo;
</script>
```
