...
legacy application, please use [@google-cloud/language](https://www.npmjs.com/package/@google-cloud/language) instead.
The [@google-cloud/language](https://www.npmjs.com/package/@google-cloud/language) library is faster, easier to use, and better maintained.
...
```sh
$ cd src/apis/language
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/language.min.js`. Use it from your HTML file:

```html
<script src="/path/to/language.min.js"></script>
<script>
