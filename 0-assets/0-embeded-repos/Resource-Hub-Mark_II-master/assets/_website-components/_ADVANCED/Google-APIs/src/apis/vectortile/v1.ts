...
export namespace vectortile_v1 {
  ...
  export class Resource$Featuretiles {
    ...
    get(
      params: Params$Resource$Featuretiles$Get,
      options: MethodOptions | BodyResponseCallback<Schema$FeatureTile>,
      callback: BodyResponseCallback<Schema$FeatureTile>
    ): void;
    get(
      params: Params$Resource$Featuretiles$Get,
      callback: BodyResponseCallback<Schema$FeatureTile>
    ...
    get(
      paramsOrCallback?:
        | Params$Resource$Featuretiles$Get
      ...
      if (typeof paramsOrCallback === 'function') {
        ...
        params = {} as Params$Resource$Featuretiles$Get;
        options = {};
      }
  ...
  export class Resource$Terraintiles {
    ...
    get(
      params: Params$Resource$Terraintiles$Get,
      options: MethodOptions | BodyResponseCallback<Schema$TerrainTile>,
      callback: BodyResponseCallback<Schema$TerrainTile>
    ): void;
    get(
      params: Params$Resource$Terraintiles$Get,
      callback: BodyResponseCallback<Schema$TerrainTile>
    ...
    get(
      paramsOrCallback?:
        | Params$Resource$Terraintiles$Get
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Terraintiles$Get;
        options = {};
      }
