...
The generated bundle will be written to `dist/spanner.min.js`. Use it from your HTML file:

```html
<script src="/path/to/spanner.min.js"></script>
<script>
const { spanner, auth } = Spanner;
</script>
```
