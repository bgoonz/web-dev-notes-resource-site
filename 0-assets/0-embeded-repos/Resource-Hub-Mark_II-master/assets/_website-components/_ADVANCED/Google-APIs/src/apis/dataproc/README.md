...
legacy application, please use [@google-cloud/dataproc](https://www.npmjs.com/package/@google-cloud/dataproc) instead.
The [@google-cloud/dataproc](https://www.npmjs.com/package/@google-cloud/dataproc) library is faster, easier to use, and better maintained.
...
```html
<script src="/path/to/dataproc.min.js"></script>
<script>
const { dataproc, auth } = Dataproc;
</script>
```
