...
```sh
$ cd src/apis/indexing
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/indexing.min.js`. Use it from your HTML file:

```html
<script src="/path/to/indexing.min.js"></script>
<script>
const { indexing, auth } = Indexing;
</script>
```
