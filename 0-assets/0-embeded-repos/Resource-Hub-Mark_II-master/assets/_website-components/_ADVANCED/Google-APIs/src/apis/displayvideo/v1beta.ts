...
export namespace displayvideo_v1beta {
  ...
  export class Resource$Sdfdownloadtask$Operations {
     ...
     */
    get(
      params: Params$Resource$Sdfdownloadtask$Operations$Get,
      options: StreamMethodOptions
    ): GaxiosPromise<Readable>;
    get(
      params?: Params$Resource$Sdfdownloadtask$Operations$Get,
    ...
    get(
      paramsOrCallback?:
        | Params$Resource$Sdfdownloadtask$Operations$Get
      ...
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Sdfdownloadtask$Operations$Get;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Sdfdownloadtask$Operations$Get;
        options = {};
      }
  ...
  export interface Params$Resource$Sdfdownloadtask$Operations$Get
