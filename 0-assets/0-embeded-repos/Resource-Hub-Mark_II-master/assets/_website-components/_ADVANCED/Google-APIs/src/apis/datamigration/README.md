...
```sh
$ cd src/apis/datamigration
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/datamigration.min.js`. Use it from your HTML file:

```html
<script src="/path/to/datamigration.min.js"></script>
<script>
const { datamigration, auth } = Datamigration;
</script>
```
