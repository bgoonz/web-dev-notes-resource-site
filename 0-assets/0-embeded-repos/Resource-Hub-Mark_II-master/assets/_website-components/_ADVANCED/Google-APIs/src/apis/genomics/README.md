...
```sh
$ cd src/apis/genomics
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/genomics.min.js`. Use it from your HTML file:

```html
<script src="/path/to/genomics.min.js"></script>
<script>
const { genomics, auth } = Genomics;
</script>
```
