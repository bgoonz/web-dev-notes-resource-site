...
The generated bundle will be written to `dist/streetviewpublish.min.js`. Use it from your HTML file:

```html
<script src="/path/to/streetviewpublish.min.js"></script>
<script>
const { streetviewpublish, auth } = Streetviewpublish;
</script>
```
