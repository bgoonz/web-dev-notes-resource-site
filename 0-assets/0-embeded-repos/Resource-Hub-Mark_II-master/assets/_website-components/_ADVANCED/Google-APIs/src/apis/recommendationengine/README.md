...
```sh
$ cd src/apis/recommendationengine
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/recommendationengine.min.js`. Use it from your HTML file:

```html
<script src="/path/to/recommendationengine.min.js"></script>
<script>
const { recommendationengine, auth } = Recommendationengine;
</script>
```
