...
legacy application, please use [@google-cloud/resource](https://www.npmjs.com/package/@google-cloud/resource) instead.
The [@google-cloud/resource](https://www.npmjs.com/package/@google-cloud/resource) library is faster, easier to use, and better maintained.
...
```html
<script src="/path/to/cloudresourcemanager.min.js"></script>
<script>
const { cloudresourcemanager, auth } = Cloudresourcemanager;
</script>
```
