...
```sh
$ cd src/apis/gamesManagement
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/gamesManagement.min.js`. Use it from your HTML file:

```html
<script src="/path/to/gamesManagement.min.js"></script>
<script>
const { gamesManagement, auth } = Gamesmanagement;
</script>
```
