...
```sh
$ cd src/apis/firebasedatabase
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/firebasedatabase.min.js`. Use it from your HTML file:

```html
<script src="/path/to/firebasedatabase.min.js"></script>
<script>
const { firebasedatabase, auth } = Firebasedatabase;
</script>
```
