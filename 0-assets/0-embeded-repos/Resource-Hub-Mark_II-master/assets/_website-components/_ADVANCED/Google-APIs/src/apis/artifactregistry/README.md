...
```sh
$ cd src/apis/artifactregistry
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/artifactregistry.min.js`. Use it from your HTML file:

```html
<script src="/path/to/artifactregistry.min.js"></script>
<script>
const { artifactregistry, auth } = Artifactregistry;
</script>
```
