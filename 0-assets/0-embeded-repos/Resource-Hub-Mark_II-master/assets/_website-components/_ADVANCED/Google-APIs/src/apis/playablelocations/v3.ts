...
export namespace playablelocations_v3 {
  ...
  export class Resource$V3 {
    ...
    logImpressions(
      ...
      if (typeof paramsOrCallback === 'function') {
        ...
        params = {} as Params$Resource$V3$Logimpressions;
        options = {};
      }
      ...
      const rootUrl =
        options.rootUrl || 'https://playablelocations.googleapis.com/';
      const parameters = {
    ...
    logPlayerReports(
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$V3$Logplayerreports;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v3:logPlayerReports').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    samplePlayableLocations(
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$V3$Sampleplayablelocations;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v3:samplePlayableLocations').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export interface Params$Resource$V3$Logimpressions
  ...
  export interface Params$Resource$V3$Logplayerreports
    extends StandardParameters {
    /**
     * Request body metadata
     */
  ...
  export interface Params$Resource$V3$Sampleplayablelocations
    extends StandardParameters {
    /**
     * Request body metadata
     */
