...
legacy application, please use [@google-cloud/speech](https://www.npmjs.com/package/@google-cloud/speech) instead.
The [@google-cloud/speech](https://www.npmjs.com/package/@google-cloud/speech) library is faster, easier to use, and better maintained.
...
The generated bundle will be written to `dist/speech.min.js`. Use it from your HTML file:

```html
<script src="/path/to/speech.min.js"></script>
<script>
const { speech, auth } = Speech;
</script>
```
