...
legacy application, please use [@google-cloud/secret-manager](https://www.npmjs.com/package/@google-cloud/secret-manager) instead.
The [@google-cloud/secret-manager](https://www.npmjs.com/package/@google-cloud/secret-manager) library is faster, easier to use, and better maintained.
