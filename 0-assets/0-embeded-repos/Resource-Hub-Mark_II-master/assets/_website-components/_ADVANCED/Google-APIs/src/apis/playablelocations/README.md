...
```sh
$ cd src/apis/playablelocations
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/playablelocations.min.js`. Use it from your HTML file:

```html
<script src="/path/to/playablelocations.min.js"></script>
<script>
const { playablelocations, auth } = Playablelocations;
</script>
```
