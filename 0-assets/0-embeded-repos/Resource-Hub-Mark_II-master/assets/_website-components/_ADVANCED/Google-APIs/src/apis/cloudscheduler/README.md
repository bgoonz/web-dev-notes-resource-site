...
legacy application, please use [@google-cloud/scheduler](https://www.npmjs.com/package/@google-cloud/scheduler) instead.
The [@google-cloud/scheduler](https://www.npmjs.com/package/@google-cloud/scheduler) library is faster, easier to use, and better maintained.
...
```html
<script src="/path/to/cloudscheduler.min.js"></script>
<script>
const { cloudscheduler, auth } = Cloudscheduler;
</script>
```
