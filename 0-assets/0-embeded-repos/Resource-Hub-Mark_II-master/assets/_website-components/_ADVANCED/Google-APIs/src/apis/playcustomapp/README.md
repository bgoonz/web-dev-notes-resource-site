...
```sh
$ cd src/apis/playcustomapp
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/playcustomapp.min.js`. Use it from your HTML file:

```html
<script src="/path/to/playcustomapp.min.js"></script>
<script>
const { playcustomapp, auth } = Playcustomapp;
</script>
```
