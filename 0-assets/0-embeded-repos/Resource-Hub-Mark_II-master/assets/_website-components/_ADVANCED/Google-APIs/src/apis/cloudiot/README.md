...
legacy application, please use [@google-cloud/iot](https://www.npmjs.com/package/@google-cloud/iot) instead.
The [@google-cloud/iot](https://www.npmjs.com/package/@google-cloud/iot) library is faster, easier to use, and better maintained.
