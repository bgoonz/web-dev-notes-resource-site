...
The generated bundle will be written to `dist/manufacturers.min.js`. Use it from your HTML file:

```html
<script src="/path/to/manufacturers.min.js"></script>
<script>
const { manufacturers, auth } = Manufacturers;
</script>
```
