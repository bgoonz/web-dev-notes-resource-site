...
```sh
$ cd src/apis/websecurityscanner
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/websecurityscanner.min.js`. Use it from your HTML file:

```html
<script src="/path/to/websecurityscanner.min.js"></script>
<script>
const { websecurityscanner, auth } = Websecurityscanner;
</script>
```
