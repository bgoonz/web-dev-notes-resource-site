...
function c( e, t ) {
  ...
  for ( var r in t ) t.hasOwnProperty( r ) && ( e[ r ] = c( e[ r ], t[ r ] ) );
  return e
}
/**
 * @license
...
var u = function () {
  function e() {
    var e = this;
    this.reject = function () {}, this.resolve = function () {}, this.promise = new Promise( ( function ( t, r ) {
...
var g = function ( e ) {
    function r( t, n ) {
      ...
      return i.code = t, i.name = "FirebaseError", Object.setPrototypeOf( i, r.prototype ), Error.captureStackTrace && Error.captureStackTrace( i, b.prototype.create ), i
    }
    return t( r, e ), r
  }( Error ),
  b = function () {
    ...
    return e.prototype.create = function ( e ) {
      ...
      for ( var n = t[ 0 ] || {}, i = this.service + "/" + e, o = this.errors[ e ], a = o ? w( o, n ) : "Error", s = this.serviceName + ": " + a + " (" + i + ").", c = new g( i, s ), u = 0, l = Object.keys( n ); u < l.length; u++ ) {
        var p = l[ u ];
...
function w( e, t ) {
  return e.replace( E, ( function ( e, r ) {
    var n = t[ r ];
...
var I = function () {
  ...
  return e.prototype.next = function ( e ) {
    ...
    void 0 === ( n = function ( e, t ) {
      ...
      error: t,
      complete: r
    } ).next && ( n.next = N ), void 0 === n.error && ( n.error = N ), void 0 === n.complete && ( n.complete = N );
...
var L = function () {
  ...
  A = function () {
    ...
    return e.prototype.get = function ( e ) {
      ...
      try {
        for ( var n = o( this.instancesDeferred.entries() ), i = n.next(); !i.done; i = n.next() ) {
          var s = a( i.value, 2 ),
            c = s[ 0 ],
            u = s[ 1 ],
...
var F, C = {
  ...
  T = D.INFO,
  k = ( ( S = {} )[ D.DEBUG ] = "log", S[ D.VERBOSE ] = "log", S[ D.INFO ] = "info", S[ D.WARN ] = "warn", S[ D.ERROR ] = "error", S ),
  x = function ( e, t ) {
    ...
    if ( !( t < e.logLevel ) ) {
      ...
      console[ o ].apply( console, P( [ "[" + i + "]  " + e.name + ":" ], r ) )
    }
  },
  H = function () {
    function e( e ) {
      this.name = e, this._logLevel = T, this._logHandler = x, this._userLogHandler = null, j.push( this )
    }
    return Object.defineProperty( e.prototype, "logLevel", {
      ...
      set: function ( e ) {
        if ( !( e in D ) ) throw new TypeError( "Invalid value assigned to `logLevel`" );
        this._logLevel = e
      },
      enumerable: !0,
      configurable: !0
      ...
      this._userLogHandler && this._userLogHandler.apply( this, P( [ this, D.DEBUG ], e ) ), this._logHandler.apply( this, P( [ this, D.DEBUG ], e ) )
    }, e.prototype.log = function () {
      for ( var e = [], t = 0; t < arguments.length; t++ ) e[ t ] = arguments[ t ];
      this._userLogHandler && this._userLogHandler.apply( this, P( [ this, D.VERBOSE ], e ) ), this._logHandler.apply( this, P( [ this, D.VERBOSE ], e ) )
    }, e.prototype.info = function () {
      for ( var e = [], t = 0; t < arguments.length; t++ ) e[ t ] = arguments[ t ];
      this._userLogHandler && this._userLogHandler.apply( this, P( [ this, D.INFO ], e ) ), this._logHandler.apply( this, P( [ this, D.INFO ], e ) )
    }, e.prototype.warn = function () {
      for ( var e = [], t = 0; t < arguments.length; t++ ) e[ t ] = arguments[ t ];
      this._userLogHandler && this._userLogHandler.apply( this, P( [ this, D.WARN ], e ) ), this._logHandler.apply( this, P( [ this, D.WARN ], e ) )
    }, e.prototype.error = function () {
      for ( var e = [], t = 0; t < arguments.length; t++ ) e[ t ] = arguments[ t ];
      this._userLogHandler && this._userLogHandler.apply( this, P( [ this, D.ERROR ], e ) ), this._logHandler.apply( this, P( [ this, D.ERROR ], e ) )
    }, e
  }();

function U( e ) {
  var t = "string" == typeof e ? C[ e ] : e;
  j.forEach( ( function ( e ) {
    e.logLevel = t
  } ) )
}
var z, B = ( ( F = {} )[ "no-app" ] = "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()", F[ "bad-app-name" ] = "Illegal App name: '{$appName}", F[ "duplicate-app" ] = "Firebase App named '{$appName}' already exists", F[ "app-deleted" ] = "Firebase App named '{$appName}' already deleted", F[ "invalid-app-argument" ] = "firebase.{$appName}() takes either no argument or a Firebase App instance.", F[ "invalid-log-argument" ] = "First argument to `onLog` must be null or a function.", F ),
  V = new b( "app", "Firebase", B ),
  M = ( ( z = {} )[ "@firebase/app" ] = "fire-core", z[ "@firebase/analytics" ] = "fire-analytics", z[ "@firebase/auth" ] = "fire-auth", z[ "@firebase/database" ] = "fire-rtdb", z[ "@firebase/functions" ] = "fire-fn", z[ "@firebase/installations" ] = "fire-iid", z[ "@firebase/messaging" ] = "fire-fcm", z[ "@firebase/performance" ] = "fire-perf", z[ "@firebase/remote-config" ] = "fire-rc", z[ "@firebase/storage" ] = "fire-gcs", z[ "@firebase/firestore" ] = "fire-fst", z[ "fire-js" ] = "fire-js", z[ "firebase-wrapper" ] = "fire-js-all", z ),
  W = new H( "@firebase/app" ),
  G = function () {
    function e( e, t, r ) {
      var n, i, a = this;
      this.firebase_ = r, this.isDeleted_ = !1, this.name_ = t.name, this.automaticDataCollectionEnabled_ = t.automaticDataCollectionEnabled || !1, this.options_ = c( void 0, e ), this.container = new R( t.name ), this._addComponent( new L( "app", ( function () {
        return a
      } ), "PUBLIC" ) );
      try {
        for ( var s = o( this.firebase_.INTERNAL.components.values() ), u = s.next(); !u.done; u = s.next() ) {
          var l = u.value;
    ...
    return Object.defineProperty( e.prototype, "automaticDataCollectionEnabled", {
      ...
      return void 0 === t && ( t = "[DEFAULT]" ), this.checkDestroyed_(), this.container.getProvider( e ).getImmediate( {
        identifier: t
      } )
      ...
      try {
        ...
        W.debug( "Component " + e.name + " failed to register with FirebaseApp " + this.name, t )
      }
...
function $( e ) {
  var t = {},
    ...
    n = {
      ...
      initializeApp: function ( r, i ) {
        ...
        if ( O( t, a ) ) throw V.create( "duplicate-app", {
          appName: a
        } );
        var s = new e( r, o, n );
        return t[ a ] = s, s
      ...
      registerVersion: function ( e, t, r ) {
        var n, i = null !== ( n = M[ e ] ) && void 0 !== n ? n : e;
        r && ( i += "-" + r );
        var o = i.match( /\s|\// ),
          s = t.match( /\s|\// );
        if ( o || s ) {
          var c = [ 'Unable to register library "' + i + '" with version "' + t + '":' ];
          return o && c.push( 'library name "' + i + '" contains illegal characters (whitespace or "/")' ), o && s && c.push( "and" ), s && c.push( 'version name "' + t + '" contains illegal characters (whitespace or "/")' ), void W.warn( c.join( " " ) )
        }
        a( new L( i + "-version", ( function () {
          return {
            library: i,
            version: t
          }
      ...
      onLog: function ( e, t ) {
        ...
        ! function ( e, t ) {
          for ( var r = function ( r ) {
              var n = null;
              t && t.level && ( n = C[ t.level ] ), r.userLogHandler = null === e ? null : function ( t, r ) {
                ...
                r >= ( null != n ? n : t.logLevel ) && e( {
                  level: D[ r ].toLowerCase(),
                  message: a,
                  args: i,
                  type: t.name
                } )
  ...
  function i( e ) {
    if ( !O( t, e = e || "[DEFAULT]" ) ) throw V.create( "no-app", {
      appName: e
    } );
    return t[ e ]
  }
  ...
  function a( a ) {
    var s, u, l = a.name;
    if ( r.has( l ) ) return W.debug( "There were multiple attempts to register component " + l + "." ), "PUBLIC" === a.type ? n[ l ] : null;
    if ( r.set( l, a ), "PUBLIC" === a.type ) {
      var p = function ( e ) {
        if ( void 0 === e && ( e = i() ), "function" != typeof e[ l ] ) throw V.create( "invalid-app-argument", {
          appName: l
        } );
        return e[ l ]()
      };
      void 0 !== a.serviceProps && c( p, a.serviceProps ), n[ l ] = p, e.prototype[ l ] = function () {
        for ( var e = [], t = 0; t < arguments.length; t++ ) e[ t ] = arguments[ t ];
        var r = this._getService.bind( this, l );
        return r.apply( this, a.multipleInstances ? e : [] )
      }
    }
    try {
      for ( var f = o( Object.keys( t ) ), h = f.next(); !h.done; h = f.next() ) {
        var d = h.value;
        t[ d ]._addComponent( a )
      }
    } catch ( e ) {
...
var Y = function e() {
    var t = $( G );
    return t.INTERNAL = r( r( {}, t.INTERNAL ), {
...
if ( "object" == typeof self && self.self === self && void 0 !== self.firebase ) {
  ...
  J && J.indexOf( "LITE" ) >= 0 && W.warn( "\n    Warning: You are trying to load Firebase while using Firebase Performance standalone script.\n    You should load Firebase Performance with this instance of Firebase to avoid loading duplicate code.\n    " )
}
var Z = Y.initializeApp;
...
var q = Y;
! function ( e, t ) {
  e.INTERNAL.registerComponent( new L( "platform-logger", ( function ( e ) {
    return new K( e )
  } ), "PRIVATE" ) ), e.registerVersion( "@firebase/app", "0.6.1", t ), e.registerVersion( "fire-js", "" )
}( q );
export {
  L as C, D as L, t as _, n as a, i as b, s as c, r as d, H as e, d as f, l as g, v as h, p as i, y as j, m as k, h as l, q as t
};
