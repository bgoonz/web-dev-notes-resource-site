...
* `yarn start` or `npm start` to view the app in the browser.
* `yarn test` or `npm test` to run the test watch script.
* `yarn lint:watch` or `npm run lint:watch` to run the auxiliary linter, which checks for PropType usage, etc.
