    ...
    function ( e, o, t ) {
      ...
      function a( e, o ) {
        ...
        return (
          ...
          ( p = i(
            ...
            "fields",
            encodeURIComponent(
              "function" == typeof e.fields.join ? e.fields.join( " " ) : void 0
            )
          ) ),
      ...
      function u( e, o ) {
        var t,
          ...
          i =
          Dropbox.baseUrl + "/dropins/job_status?job=" + o + "&app_key=" + r;
        i = s( i );
        var a = function ( o ) {
              ...
              ( r.onreadystatechange = function () {
                if ( "loaded" === r.readyState )
                  return (
                    ...
                    null != r.parentNode ? r.parentNode.removeChild( r ) : void 0
                  );
              } ),
      ...
      function p( e, t, n ) {
        ...
        switch (
          ( ( r =
              null != o.ieframe && n._popup ? o.ieframe.contentWindow : e.source ),
      ...
      var n =
        ...
        function () {
          ...
          var n = Array( e ),
            r = 0;
          for ( o = 0; o < t; o++ )
            for ( var i = arguments[ o ], s = 0, a = i.length; s < a; s++, r++ )
              n[ r ] = i[ s ];
          return n;
        };
      Object.defineProperty( o, "__esModule", {
      ...
      ( o.initModule = function () {
        ...
        Dropbox.save = function () {
          ...
          if ( Dropbox.isBrowserSupported() ) {
            if (
              ( ( r._popup = !0 ), "object" != typeof r.files || !r.files.length )
            )
              throw new Error(
            ...
            var c = n.popupDimensionsString( 735, 670 );
        ...
        var s = function ( e, o, t ) {
            ...
            var l = setInterval( function () {
              ...
              ( r(),
                "function" == typeof t.cancel && t.cancel( n.last_navigation ) );
            }, 100 );
            return (
          ...
          c = function ( e ) {
            if ( Dropbox.isBrowserSupported() ) {
              ...
              if ( e.iframe && !e.windowName ) {
                ...
                var c = n.popupDimensionsString( 735, 552 );
                r.onClose = s(
        ...
        ( Dropbox.isBrowserSupported = function () {
          var e = ( function () {
            for (
              var e = 0, o = [ /IEMobile\/(7|8|9|10)\./, /BB10;/, /CriOS/ ]; e < o.length; e++
            )
          ...
          function o( o ) {
            ...
            return (
              ( t.validateOptions = function () {
                ...
                if (
                  ( e( "initialViewType", "string" ), void 0 !== t.options.fields )
                ) {
                  if ( !( t.options.fields instanceof Array ) )
                    throw new Error(
                      "The fields option, if provided, must be an array"
                    );
                  for ( var l = 0, c = t.options.fields; l < c.length; l++ )
    ...
    function ( e, o, t ) {
      ...
      o.initModule = function () {
        ...
        ( i.genericDropins.init = function () {
          for (
            var e = document.getElementsByTagName( "a" ), o = e.length - 1; o >= 0; o--
          ) {
            var t = e[ o ],
              ...
              ( function ( e ) {
                ...
                if ( o && e.parentElement ) {
                  var t = e.getAttribute( "data-file-zoom" ) || void 0,
                    ...
                    r = e.getAttribute( "data-folder-header-size" ) || void 0,
          ...
          function e() {
            ...
            ( this.openWindow = function ( t ) {
              ...
              try {
                ...
                var u = e.attach( t, c.messagingWindow );
                s = r( [
                  function () {
                    t.sendMessage( {
                      method: "close",
                ...
                e.activeDropins.push( p ),
                  ...
                  t.hasOnCloseDialogMessage() || t.setOnCloseDialogMessage( s ),
                  ( p.cleanup = s );
              } catch ( e ) {
                throw ( s(), e );
              }
      ...
      var s = ( function ( e ) {
        function o( o ) {
          ...
          return (
            ( i.state = {
              link: i.options.link,
              file_zoom: null === ( t = i.options.file ) || void 0 === t ? void 0 : t.zoom,
              folder_view: null === ( n = i.options.folder ) || void 0 === n ?
                void 0 : n.view,
              folder_headerSize: null === ( r = i.options.folder ) || void 0 === r ?
                void 0 : r.headerSize,
            } ),
            i
          );
